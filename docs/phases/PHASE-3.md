...
| P3.5 | Build Grafana dashboard panels for Debezium lag/health | Platform Team | Completed | Dashboard `infra/grafana/debezium-lag-dashboard.json` includes thresholding for lag and event age. |
